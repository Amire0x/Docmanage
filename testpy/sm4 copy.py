...
class SM4:
    ...
    def str_to_hexStr(self, hex_str):
        ...
        :return: hex
        """
        hex_data = hex_str.encode(encoding='utf-8',errors='ignore')
        str_bin = binascii.unhexlify(hex_data)
        return str_bin.decode(encoding='utf-8',errors='ignore')
    ...
    def encryptSM4(self, encrypt_key, value):
        ...
        date_str = str(value)
        encrypt_value = crypt_sm4.crypt_ecb(date_str.encode(encoding='utf-8',errors='ignore'))  # 开始加密。bytes类型
